...
const initialState = {
  ...
  receipt: {
    ...
    cartForReceipt: testCartCurrentForDefaultReceipt // When customer checkout succeed, copy current cart to cartForReceipt
  },
  ...
  produce(state, draft => {
    switch (action.type) {
      ...
      case types.PLACE_ORDER_SUCCESS:
        console.log(
          'run to place order and cart current is:',
          draft.cartCurrent
        );
        break;
